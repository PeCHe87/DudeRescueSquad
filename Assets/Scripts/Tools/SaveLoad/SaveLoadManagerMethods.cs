...
namespace DudeRescueSquad.Tools
{
    ...
    /// <summary>
    /// The possible methods to save and load files to and from disk available in the SaveLoadManager
    /// </summary>
    public enum SaveLoadManagerMethods {
        Json,
        JsonEncrypted,
        Binary,
        BinaryEncrypted
    ...
    /// </summary>
    public abstract class SaveLoadManagerEncrypter
    {
        /// <summary>

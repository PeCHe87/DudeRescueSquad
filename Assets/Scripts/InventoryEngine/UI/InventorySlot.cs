...
namespace DudeRescueSquad.InventoryEngine
{
    ...
    public class InventorySlot : Button
    {
        ...
        public virtual void DrawIcon(InventoryItem item, int index)
        {
            if (ParentInventoryDisplay != null)
            {
                if (!InventoryItem.IsNull(item))
                {
                    ...
                    Tools.GUI.SetSize(itemRectTransform, ParentInventoryDisplay.IconSize);
                    ...
                    if (item.Quantity > 1)
                    {
                        ...
                        Tools.GUI.SetSize(textObjectRectTransform, (ParentInventoryDisplay.SlotSize - Vector2.one * ParentInventoryDisplay.QtyPadding));
                    }
                }
            }
        }
        ...
        {
            if (!SlotEnabled) { return; }
            InventoryEvent.Trigger(InventoryEventType.UseRequest, this, ParentInventoryDisplay.TargetInventoryName, ParentInventoryDisplay.TargetInventory.Content[Index], 0, Index);
        }
        ...
        public virtual void Equip()
        {
            ...
            InventoryEvent.Trigger(InventoryEventType.EquipRequest, this, ParentInventoryDisplay.TargetInventoryName, ParentInventoryDisplay.TargetInventory.Content[Index], 0, Index);
        }
